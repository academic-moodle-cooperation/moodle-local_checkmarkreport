...
$string['showpresentationcount'] = 'Zeige Anzahl von Tafelleistungen';
$string['showpresentationcount_help'] = 'Zeigt die Anzahl der Bewerteten Tafelleistungen der Teilnehmer/innen';
$string['showpresentationgrades'] = 'Zeige Tafelleistung';
$string['showpresentationgrades_help'] = 'Wenn aktiviert, zeigt die Spalte "# Tafelleistungen" für alle Kursteilnehmer/innen die Anzahl der eingetragenen Bewertungen von Tafelleistungen - über alle Kreuzerlübungen des Kurses hinweg - an. Dabei werden leere Bewertungen ignoriert und nicht gezählt.';
