...
$string['privacy:metadata:sumrelchecked'] = 'Persistently saved setting whether or not to show percentage values of checked examples.';
$string['privacy:metadata:sumrelgrade'] = 'Persistently saved setting whether or not to show percentage values of grades calculated by checked examples.';
...
$string['sumrel_help'] = 'Show relative values (XX %) of checked examples as well as of grade calculated by checked examples - for course in total and each checkmark.';
$string['sumrelchecked'] = 'Show % of examples';
$string['sumrelchecked_help'] = 'Show relative values (XX %) of checked examples - for course in total and each checkmark.';
$string['sumrelgrade'] = 'Show % of grade';
$string['sumrelgrade_help'] = 'Show relative values (XX %) of grade calculated by checked examples - for course in total and each checkmark.';
